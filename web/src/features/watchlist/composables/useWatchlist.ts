...
export function useWatchlist() {
  ...
  return {
    ...
    getStockGroupIds: store.getStockGroupIds,
    ...
    reorderWatchlistGroups: store.reorderWatchlistGroups,
    reorderWatchlistGroupStocks: store.reorderWatchlistGroupStocks,
